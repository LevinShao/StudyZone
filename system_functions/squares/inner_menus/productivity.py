...
from system_functions.squares.productivity_trackers.task_tracker import show_task_tracker
from system_functions.squares.productivity_trackers.goal_planner import show_goal_planner
from system_functions.squares.productivity_trackers.habit_management import show_habit_tracker
from system_functions.squares.productivity_trackers.fitness_tracker import show_fitness_tracker
...
def show_trackers_menu(app):
    ...
    create_square(grid, "Fitness Tracker", lambda: show_fitness_tracker(app)).grid(row=0, column=3, padx=30, pady=150)
